  ...
  schemas: {
    ...
    Availability: {
      ...
      pickupAtLocationAvailability?:
        components["schemas"]["PickupAtLocationAvailability"][];
      ...
      shipToLocationAvailability?:
        components["schemas"]["ShipToLocationAvailability"];
    };
    ...
    AvailabilityWithAll: {
      ...
      shipToLocationAvailability?:
        components["schemas"]["ShipToLocationAvailabilityWithAll"];
    };
    ...
    CompatibleProduct: {
      ...
      productFamilyProperties?:
        components["schemas"]["ProductFamilyProperties"];
    ...
    EbayOfferDetailsWithAll: {
      ...
      extendedProducerResponsibility?:
        components["schemas"]["ExtendedProducerResponsibility"];
    ...
    FulfillmentCenterSpecifications: {
      ...
      sameDayShippingCutOffTimes?:
        components["schemas"]["SameDayShippingCutOffTimes"];
    };
    ...
    GetInventoryItemResponse: {
      ...
      inventoryItem?:
        components["schemas"]["InventoryItemWithSkuLocaleGroupKeys"];
    ...
    InventoryItems: {
      ...
      inventoryItems?:
        components["schemas"]["InventoryItemWithSkuLocaleGroupid"][];
      /**
       * Format: int32
    ...
    InventoryLocation: {
      ...
      fulfillmentCenterSpecifications?:
        components["schemas"]["FulfillmentCenterSpecifications"];
    };
    ...
    ListingPolicies: {
      ...
      regionalProductCompliancePolicies?:
        components["schemas"]["RegionalProductCompliancePolicies"];
      ...
      regionalTakeBackPolicies?:
        components["schemas"]["RegionalTakeBackPolicies"];
    ...
    ShipToLocationAvailability: {
      ...
      availabilityDistributions?:
        components["schemas"]["AvailabilityDistribution"][];
      /**
       * Format: int32
...
export interface operations {
  ...
  bulkGetInventoryItem: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["BulkGetInventoryItemResponse"];
        };
      };
      /** @description Multi-Status */
      207: {
  ...
  bulkUpdatePriceQuantity: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["BulkPriceQuantityResponse"];
        };
      };
      /** @description Multi-Status */
      207: {
  ...
  bulkMigrateListing: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["BulkMigrateListingResponse"];
        };
      };
      /** @description Multi-Status */
      207: {
  ...
  bulkCreateOffer: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["BulkEbayOfferDetailsWithKeys"];
      };
    };
    responses: {
      /** @description Success */
